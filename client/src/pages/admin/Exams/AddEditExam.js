                ...
                <Col span={8}>
                  <Form.Item label="Category" name="category">
                    <select name="" id="">
                      ...
                      <option value="General">General or Mixed</option>
                      <option value="Physical">Physical Geography</option>
                      <option value="Cultural">Cultural Geography</option>
                      <option value="Bio">Bio Geography</option>
                      <option value="Human">Human Geography</option>
                      <option value="Political">Political Geography</option>
                      ...
                      <option value="Religion">Religion geography</option>
                    </select>
                  </Form.Item>
                </Col>
                <Col span={8}>
